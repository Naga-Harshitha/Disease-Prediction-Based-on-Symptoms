...
# Heading
w2 = Label(root, justify=LEFT, text="Disease Predictor using Machine Learning", fg="white", bg="black")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="A Project by PVPSIT", fg="white", bg="blue")
w2.config(font=("Aaron", 30))
...
lrLb = Label(root, text="DecisionTree", fg="red", bg="white")
